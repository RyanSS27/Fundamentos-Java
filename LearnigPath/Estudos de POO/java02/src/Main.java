...
public class Main {
    public static void main(String[] args) {
        ...
        carga = carga.replace("%", "").trim();//deixar sem o trim() não muda, deixei só por precaução
        c1.carga = Integer.parseInt(carga);

        System.out.println("Ela está aberta [true/false]? ");
        c1.aberta = sc.nextBoolean();
